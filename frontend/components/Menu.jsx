          ...
          {dropdownOpen && (
            <div style={{
              ...
              <Link legacyBehavior href="/ai-chatbot">
                <a style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 22px", color: "#ffe600", textDecoration: "none", fontWeight: 600, fontSize: 16, transition: "background 0.2s", }} onClick={() => setDropdownOpen(false)}>
                  <span style={{fontSize:20}}>🤖</span> AI Chatbot
                </a>
              </Link>
              <Link legacyBehavior href="/booking">
                <a style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 22px", color: "#ffe600", textDecoration: "none", fontWeight: 600, fontSize: 16, transition: "background 0.2s", borderTop: "1px solid #393e46" }} onClick={() => setDropdownOpen(false)}>
